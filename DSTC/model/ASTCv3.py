...
class ASTC_model(nn.Module):
    def __init__(
            ...
            *,
            ...
            SSIM_loss_weight=1.,
            feature_intermediate_loss_weight=1
    ):
        super().__init__()
        ...
        self.feature_intermediate_loss_weight = feature_intermediate_loss_weight
    ...
    def forward(
        ...
        for x_encode_len_16 in x_encode_all_len_8A8:
            real_x_encode_len_16 = x_encode_len_16
            ...
            fake_x_encode_len_16 = x_decode_len_16

            recon_intermediate_loss = F.mse_loss(real_x_encode_len_16, fake_x_encode_len_16)
            feature_intermediate_losses.append(recon_intermediate_loss)
        ...
        for x_encode_len_32 in x_encode_all_len_16A16:
            ...
            real_x_encode_len_32 = x_encode_len_32
            ...
            fake_x_encode_len_32 = x_decode_len_32
            x_decode_len_16 = self.Up_compress_4(x_decode_len_32)

            recon_intermediate_loss = F.mse_loss(real_x_encode_len_32, fake_x_encode_len_32)
            feature_intermediate_losses.append(recon_intermediate_loss)
        ...
        real_x_encode_len_64 = x_encode_all_len_32A32
        ...
        fake_x_encode_len_64 = x_decode_len_64
        x_decode_len_32 = self.Up_compress_5(x_decode_len_64)
        x_decode_len_16 = self.Up_compress_4(x_decode_len_32)

        recon_intermediate_loss = F.mse_loss(real_x_encode_len_64, fake_x_encode_len_64)
        feature_intermediate_losses.append(recon_intermediate_loss)
        ...
        feature_intermediate_loss = torch.stack(feature_intermediate_losses).mean()
        ...
        total_loss = ((recon_loss * self.recon_loss_weight) +
                      ...
                      (feature_intermediate_loss * self.feature_intermediate_loss_weight))

        if return_loss_breakdown:
            return total_loss, (recon_loss, adversarial_loss, feature_loss, SSIM_loss,
                                recon_loss_64, recon_loss_32, recon_loss_16, recon_loss_8, feature_intermediate_loss)

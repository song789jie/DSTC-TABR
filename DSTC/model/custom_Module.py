...
class Conv1DCompression(nn.Module):
    def __init__(self, in_channels=3, out_channels=4):
        super(Conv1DCompression, self).__init__()
...
class Conv1DDecompression(nn.Module):
    def __init__(self, in_channels=3, out_channels=4):
        super(Conv1DDecompression, self).__init__()
        self.in_channels = in_channels
        self.out_channels = out_channels
        self.deconv1d = nn.ConvTranspose1d(in_channels=self.in_channels,
                                           out_channels=self.out_channels,
                                           kernel_size=2, stride=2)
        self.relu = nn.ReLU()
